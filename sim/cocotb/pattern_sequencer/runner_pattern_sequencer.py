...
SOURCES = [
    ...
    SIM_DIR / "pattern_sequencer_tb_wrapper.sv",
]

SIM_BUILD = SIM_DIR / "sim_build_pattern_sequencer"
...
def compile():
    ...
    cmd = [
        ...
        f"-I{RTL_PH_CNT}",
        "-o", str(VVP_FILE),
        "-s", "pattern_sequencer_tb_wrapper",
    ] + SOURCES
...
def run(testcase=None):
    ...
    env["COCOTB_TEST_MODULES"] = "test_pattern_sequencer"
