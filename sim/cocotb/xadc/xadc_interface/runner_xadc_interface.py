...
RTL_PH_CNT = REPO_ROOT / "rtl"

SOURCES = [
    SIM_DIR / "xadc_wiz_0_stub.sv",
    REPO_ROOT / "rtl" / "xadc" / "xadc_interface.sv",
    SIM_DIR / "xadc_interface_tb_wrapper.sv",
]

SIM_BUILD = SIM_DIR / "sim_build_xadc_interface"
...
def run(testcase=None):
    ...
    env["COCOTB_TEST_MODULES"] = "test_xadc_interface"
