...
SOURCES = [
    REPO_ROOT / "rtl" / "lib" / "cdc_sync.sv",
    SIM_DIR / "cdc_sync_tb_wrapper.sv",
]

SIM_BUILD = SIM_DIR / "sim_build_cdc_sync"
...
def run(testcase=None):
    ...
    env["COCOTB_TEST_MODULES"] = "test_cdc_sync"
