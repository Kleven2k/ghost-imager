### Nexys Video Rev. A constraints — Ghost Imager (rtl/top.sv)
### Source of truth for the full pin reference: Digilent Nexys-Video-Master.xdc
###
### Only pins used by top.sv are active. Everything else from the master XDC
...
# ============================================================
set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS12 } [get_ports { b_i[8] }];  #IO_L21N_T3_DQS_A18_15 Sch=fmc_la_n[13]
set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS12 } [get_ports { b_i[9] }];  #IO_L21P_T3_DQS_15     Sch=fmc_la_p[13]
set_property -dict { PACKAGE_PIN H22   IOSTANDARD LVCMOS12 } [get_ports { b_i[10] }]; #IO_L7N_T1_AD2N_15     Sch=fmc_la_n[14]
set_property -dict { PACKAGE_PIN J22   IOSTANDARD LVCMOS12 } [get_ports { b_i[11] }]; #IO_L7P_T1_AD2P_15     Sch=fmc_la_p[14]
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS12 } [get_ports { b_i[12] }]; #IO_L23N_T3_FWE_B_15   Sch=fmc_la_n[15]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS12 } [get_ports { b_i[13] }]; #IO_L23P_T3_FOE_B_15   Sch=fmc_la_p[15]
set_property -dict { PACKAGE_PIN G18   IOSTANDARD LVCMOS12 } [get_ports { b_i[14] }]; #IO_L4N_T0_15          Sch=fmc_la_n[16]
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS12 } [get_ports { b_i[15] }]; #IO_L4P_T0_15          Sch=fmc_la_p[16]

set_false_path -from [get_ports { b_i[*] }]
